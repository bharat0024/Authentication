...
CREATE TABLE `users` (
  ...
  `email` varchar(255) NOT NULL,
  `password` varchar(256) NOT NULL,
  `activate_link` varchar(1000) DEFAULT 'http://',
...
INSERT INTO `users` VALUES ('sdsd3434sdAddSa',1,'prathvik','prathvik@gmail.com','3232321122','http://','2024-04-14 12:31:25','2024-04-04 14:31:25',1,0,'2024-04-04 12:31:25',NULL),('w1kz42sjb3ziwvtw3gqu',1,'aryaman','aryaman@gmail.com','$2a$10$JYuyguN.qg3ihN1rSf39Ge1lX5EatBgTy9G.yJ7Tk64DR5LDk84.e','w1kz42sjb3ziwvtw3gqucode=@6EVf5BOtJLqk!T6','2024-04-14 13:09:01','2024-04-04 15:09:01',1,0,'2024-04-04 13:09:01',NULL);
...
-- Dump completed on 2024-04-04 19:39:14
